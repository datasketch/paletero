test_that("Background", {
  ...
  img <- image_read(system.file("imgs","bad-bunny-9.jpg", package = "paletero"))
  ...
  img1 <- image_read(system.file("imgs","bad-bunny-4.jpg", package = "paletero")) %>%
    image_scale("200")
  ...
  img2 <- system.file("imgs","bad-bunny-9.jpg", package = "paletero")
  img3 <- image_read(system.file("imgs","bad-bunny-9.jpg", package = "paletero")) %>%
    image_scale("200")
