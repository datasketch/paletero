test_that("color helpers", {
  ...
  my_pals
  preview_colors(paletteer_colors(my_pals[1]))
  preview_colors(paletteer_colors(my_pals[2]))
  preview_colors(paletteer_colors(my_pals[3]))
  preview_colors(paletteer_colors(my_pals[4]))
  preview_colors(paletteer_colors(my_pals[5]))
  preview_colors(paletteer_colors(my_pals[6]))
  preview_colors(paletteer_colors(my_pals[7]))
  preview_colors(paletteer_colors(my_pals[8]))
  preview_colors(paletteer_colors(my_pals[9]))
  ...
  preview_colors(paletteer_colors(my_pals[8]))
  preview_colors(paletteer_colors(my_pals[9]))
  preview_colors(darken(paletteer_colors(my_pals[9])))
